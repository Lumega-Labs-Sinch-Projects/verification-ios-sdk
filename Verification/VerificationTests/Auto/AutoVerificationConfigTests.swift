//
//  AutoVerificationConfigTests.swift
//  VerificationTests
//
...
class AutoVerificationConfigTests: XCTestCase {
    ...
    func testBasicBuilder() throws {
        let builtConfiguration = AutoVerificationConfig.Builder.instance()
            .globalConfig(testGlobalConfig)
            .number(testNumber)
            .build()

        let initializedConfig = AutoVerificationConfig(globalConfig: testGlobalConfig, number: testNumber)
    ...
    func testFullBuilder() throws {
        ...
        let initializedConfig = AutoVerificationConfig(
            globalConfig: testGlobalConfig,
            number: testNumber,
            custom: testCustom,
            reference: testReference,
    ...
    func testWithVerificationProperties() {
        ...
        let built = AutoVerificationConfig.Builder.instance()
            .globalConfig(testGlobalConfig)
